...
export default function page() {
  ...
  return (
    <main className="flex flex-col items-center justify-center rounded-4xl h-[90vh] w-[90vw] p-8 lg:p-20 mt-40">
      ...
      {showForm ?(
      <form id="queryForm" onSubmit={handleSubmit} className="flex flex-col items-center justify-center w-fit border rounded-2xl m-8 bg-linear-to-tr from-cyan-950 to-25% to-zinc-600">
        <div className="flex">
        ...
        <input type="submit" className="flex items-center justify-center rounded-4xl w-[100px] h-[30px] shadow-2xl drop-shadow-lg drop-shadow-amber-950 transition-all duration-100 scale-125 hover:drop-shadow-2xl hover:drop-shadow-amber-950 hover:scale-150 active:scale-75 active:bg-neutral-800 bg-linear-to-tr from-neutral-700 to-neutral-400 to=40% text-amber-600 hover:text-amber-700 active:text-amber-950 active:drop-shadow-lg active:drop-shadow-amber-950 justify-self-center mt-8 mb-4" value="Submit!" />
      </form>)
       : (
